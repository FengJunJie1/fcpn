...
\begin{itemize}
	...
	In the end, run the code to get the trained parameters and fill them in FCPN. Make sure the type of membership functions should be selected as \textbf{Gauss} and the AND Method should be selected as \textbf{Minimum}.
